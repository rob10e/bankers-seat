...
- Server provides `/api/v1/templates`, `/api/v1/sessions`, `/api/v1/sessions/join`, `/api/v1/sessions/{sessionId}/reconnect`, `/api/v1/sessions/{sessionId}/snapshot`, `/api/v1/sessions/{sessionId}/transfer`, `/api/v1/sessions/{sessionId}/corrections`, `/api/v1/sessions/{sessionId}/ledger`, and `/api/v1/sessions/{sessionId}/export`.
...
- Financial transfer/correction command handling is implemented with session-version checks, idempotency, and immutable ledger transaction/posting persistence.
