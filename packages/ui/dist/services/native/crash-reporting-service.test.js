...
describe("CrashReportingService", () => {
    ...
    it("captures exceptions to the logger", () => {
        ...
        expect(logger.error).toHaveBeenCalledWith("[CrashReporting] exception", expect.objectContaining({
    ...
    it("captures messages at the correct log level", () => {
        ...
        expect(logger.warn).toHaveBeenCalledWith("[CrashReporting] message", expect.objectContaining({ message: "heads up", level: "warning" }));
        expect(logger.error).toHaveBeenCalledWith("[CrashReporting] message", expect.objectContaining({ message: "broken", level: "error" }));
    });
